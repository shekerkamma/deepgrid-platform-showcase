// The showcase's published content as citable units: every product, every slide, every use case and every
// passage of the investment memorandum. Both halves of Ask DeepGrid read it from here:
