...
const CHAPTERS = [
  ...
  {id: 'domains', kicker: 'Six domains', slides: [5], passages: [['sc_converted_showcase_investment_memorandum_md_16', 'Six chiplets, one 57 mm² die'], [IM2 + '18', 'The six-domain die']],
    brief: 'The six compute domains on the die, and how each one is a product line in its own right. Make the pills the six domains themselves, in this order: value is the domain code and its area (for example "A100 · ~7 mm²"), and label is exactly the domain name: A100 "AI / ADAS processor", R100 "Radar DSP", T100 "Edge AI, thermal and LiDAR", D100 "Defence secure compute", S100 "SDV and vehicle gateway", H100 "Health AI processor". Do not repeat die-level figures (TOPS, bandwidth, NRE, yield). Keep the detail to one short sentence per domain.'},
