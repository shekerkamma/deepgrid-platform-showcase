...
export function SectionHead({tag,title,copy}:{tag?:string;title:string;copy:string}){return <header className="section-head"><div>{tag&&<Eyebrow>{tag}</Eyebrow>}<h1>{title}</h1></div><p>{copy}</p></header>}
